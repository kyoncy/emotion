...
var checkExpressionPreferringObject = function checkExpressionPreferringObject(
  context,
  node
) {
  switch (node.type) {
...
var checkExpressionPreferringString = function checkExpressionPreferringString(
  context,
  node
) {
  switch (node.type) {
...
var jsxImport = {
  ...
  create: function create(context) {
    var jsxRuntimeMode = context.options.find(function (option) {
      return option && option.runtime === 'automatic'
    })
        ...
        JSXAttribute: function JSXAttribute(node) {
          ...
          if (!jsxImportSourceMatch) {
            context.report({
              node: node,
              message:
                'The css prop can only be used if jsxImportSource is set to ' +
                importSource,
              fix: function fix(fixer) {
